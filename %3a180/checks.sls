(library (srfi :180 checks)
  ...
  (begin
    ...
    (define i_number_huge_exp.json
      ;; chez treat 0.4e00669999 as 0.4e669999
    ...
    (define i_object_key_lone_2nd_surrogate.json
      (skip check '(("\xDF;\xAA;" . 0)) (parse "./files/i_object_key_lone_2nd_surrogate.json")))
    ...
    (define n_string_1_surrogate_then_escape.json
      ;; (integer->char #xD800) will raise a exception
    ...
    (define y_object_empty_key.json
      (check `((,(string->symbol "") . 0)) (parse "./files/y_object_empty_key.json")))

    ;; TODO: add escaped null char
    (define y_object_escaped_null_in_key.json
      (skip check '(("foo\x00;\x00;bar" . 42)) (parse "./files/y_object_escaped_null_in_key.json")))
    ...
    (define y_string_u+2028_line_sep.json
      (check '#("\x2028;") (parse "./files/y_string_u+2028_line_sep.json")))
